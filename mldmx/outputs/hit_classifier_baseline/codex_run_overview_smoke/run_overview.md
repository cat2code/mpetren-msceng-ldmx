...
## Run
- Output directory: `mldmx/outputs/hit_classifier_baseline/codex_run_overview_smoke`
- Created UTC: `2026-06-10T08:25:39.454394+00:00`
...
| `run_name` | `codex_run_overview_smoke` |
| `epochs` | `1` |
| `batch_size` | `4` |
| `lr` | `0.001` |
| `weight_decay` | `0.0` |
