...
## Run
- Output directory: `mldmx/outputs/hit_classifier_baseline/codex_vectorized_metrics_smoke`
- Created UTC: `2026-06-10T09:03:00.840883+00:00`
...
| `run_name` | `codex_vectorized_metrics_smoke` |
| `epochs` | `1` |
| `batch_size` | `4` |
| `lr` | `0.001` |
| `weight_decay` | `0.0` |
