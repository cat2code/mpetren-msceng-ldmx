...
\begin{itemize}
    ...
    \item \textbf{Compare model architectures:} evaluate GravNet and
    Transformer baselines using common inputs and targets, considering both
    ...
    \item \textbf{Explore a broader reconstruction task:} extend fixed-count
    hit assignment with a mixed-multiplicity Transformer that predicts electron
...
continued reconstruction studies, rather than a production trigger algorithm,
