...
reconstructed trigger-pad-track observations. Sensitivity to the latter is
examined through inference-time ablation, with the resulting distribution
shift treated as a limitation. Both architectures learn relations within unordered,
