...
## Run
- Output directory: `mldmx/outputs/hit_classifier_baseline/codex_true_batching_transformer_smoke`
- Created UTC: `2026-06-10T10:03:17.209312+00:00`
...
| `run_name` | `codex_true_batching_transformer_smoke` |
| `epochs` | `1` |
| `batch_size` | `4` |
| `lr` | `0.001` |
| `weight_decay` | `0.0` |
