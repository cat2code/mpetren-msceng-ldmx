...
\newglossaryentry{ecal shower}{
    name={ECAL shower},
    first={\emph{ECAL shower}},
    description={An electromagnetic cascade initiated when electrons or photons enter the electromagnetic calorimeter. Its topology and energy profile are central to background rejection.},
    category={term}
}
...
\newabbreviation[type=acronym, category=acro]{ldmxsw}{LDMX-SW}{LDMX-Software}
