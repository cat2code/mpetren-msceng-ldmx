...
\newglossaryentry{dark photon}{
    ...
    description={A hypothetical dark-sector gauge boson \(A'\) that acts as a mediator between \gls{sm} and dark-sector particles; one of the primary physics targets of \gls{ldmx}.},
    category={term}
}
...
\newabbreviation[
    type=acronym,
    category=acro,
    description={For a set of values \(x_1,\ldots,x_N\), the root mean square is defined as
...
\newabbreviation[type=acronym, category=acro]{slac}{SLAC}{SLAC National Accelerator Laboratory}
...
\newabbreviation[type=acronym, category=acro]{trace}{TRACE}{Transformer for Reconstruction and Attribution of Calorimeter Energy}
