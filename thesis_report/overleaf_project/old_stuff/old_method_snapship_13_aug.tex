...
count in advance, this motivated an expansion a multi-task
Transformer model, more experimental in nature, that additionally predicts the valid electron slots in a mixed \(2e/3e\) sample, the set of contributors and their energy fractions, drawing inspiration from particle flow-type metrics. 

\subsection{Simulation}

The samples used in this study were produced with \gls{ldmxsw}. Its
versioned Docker\footnote{Explain docker here} container release captures the framework and its software
...
\input{config/fig/model_architecture_baselines}[H]
