...
## Run
- Output directory: `mldmx/outputs/hit_classifier_baseline/codex_val_event_accuracy_smoke`
- Created UTC: `2026-06-10T11:02:28.258727+00:00`
...
| `run_name` | `codex_val_event_accuracy_smoke` |
| `epochs` | `1` |
| `batch_size` | `4` |
| `lr` | `0.001` |
| `weight_decay` | `0.0` |
