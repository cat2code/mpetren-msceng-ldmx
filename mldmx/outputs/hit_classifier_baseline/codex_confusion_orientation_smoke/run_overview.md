...
## Run
- Output directory: `mldmx/outputs/hit_classifier_baseline/codex_confusion_orientation_smoke`
- Created UTC: `2026-06-10T11:16:51.175242+00:00`
...
- Training view function: `ecal_transformer_view`
- Model-view cache: `{"enabled": false, "policy": "on_demand"}`
...
| `run_name` | `codex_confusion_orientation_smoke` |
| `epochs` | `1` |
| `batch_size` | `4` |
| `lr` | `0.001` |
| `weight_decay` | `0.0` |
