...
The Transformer is a special case of the GNN \cite{joshi2025transformersgnn}. Here, GNN is understood in the
...
* GNN, Transformer work with unordered sets of input compared to CNN that is on a regular grid. We are using different detectors and different objects and the ECal has a hexagonal grid and all of this adds to difficulty of using CNNs. 
