...
## Run
- Output directory: `mldmx/outputs/hit_classifier_baseline/codex_true_batching_tpad_transformer_smoke`
- Created UTC: `2026-06-10T10:03:33.627893+00:00`
...
## Model
- Requested model: `ECalTpadTransformer`
- Class: `mldmx.models.ecal_transformer.ECalTpadTransformer`
- Input dimension: `8`
- Output dimension: `3`
- Trainable parameters: `771`
- Total parameters: `771`
...
## Data
- Resolved data dir: `mldmx/data/processed/ecal_tpad_3class_smoke`
- Loaded events: `10`
...
- View function: `ecal_tpad_transformer_view`
- Training view function: `ecal_tpad_transformer_view`
...
| `processed_dir` | `mldmx/data/processed/ecal_tpad_3class_smoke` |
...
| `run_name` | `codex_true_batching_tpad_transformer_smoke` |
| `epochs` | `1` |
| `batch_size` | `4` |
| `lr` | `0.001` |
| `weight_decay` | `0.0` |
...
| --- | ---: | ---: | --- | --- |
| `input_proj.0.weight` | `[8, 8]` | `64` | `True` | `torch.float32` |
